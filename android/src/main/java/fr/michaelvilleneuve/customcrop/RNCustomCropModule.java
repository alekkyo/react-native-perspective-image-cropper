...
public class RNCustomCropModule extends ReactContextBaseJavaModule {
    ...
    public void crop(ReadableMap points, String imageUri, Callback callback) {
        ...
        double appWidth = points.getDouble("width");
        double appHeight = points.getDouble("height");
        ...
        double widthRatio = src.size().width / appWidth;
        double heightRatio = src.size().height / appHeight;

        double widthA = Math.sqrt(Math.pow(br.x - bl.x, 2) + Math.pow(br.y - bl.y, 2));
        double widthB = Math.sqrt(Math.pow(tr.x - tl.x, 2) + Math.pow(tr.y - tl.y, 2));

        double dw = Math.max(widthA, widthB) * widthRatio;
        int maxWidth = Double.valueOf(dw).intValue();

        double heightA = Math.sqrt(Math.pow(tr.x - br.x, 2) + Math.pow(tr.y - br.y, 2));
        double heightB = Math.sqrt(Math.pow(tl.x - bl.x, 2) + Math.pow(tl.y - bl.y, 2));

        double dh = Math.max(heightA, heightB) * heightRatio;
        ...
        map.putString("widthRatio", String.valueOf(widthRatio));
        map.putString("heightRatio", String.valueOf(heightRatio));
        map.putString("imageWidth", String.valueOf(src.size().width));
        map.putString("imageHeight", String.valueOf(src.size().height));
        map.putString("widthA", String.valueOf(widthA));
        map.putString("widthB", String.valueOf(widthB));
        map.putString("heightA", String.valueOf(heightA));
        map.putString("heightB", String.valueOf(heightB));
